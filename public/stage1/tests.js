...
describe('ステージ1（意図した DOM 要素を取得できるようになる）', function() {
  ...
  describe('基本 CSS セレクタ編', function() {
    ...
    it('2 番の橙色の要素を querySelector を使って1つ取得できる', function() {
      ...
      // var element = document.querySelector('[id="chocolate"]');
      var element = document.querySelector('[title="chocolate"]');
    ...
    it('3 番の緑色の要素を querySelector を使って1つ取得できる', function() {
      ...
      // var element = document.querySelector('ul:nth-child(1) li:nth-child(3)');
      var element = document.querySelector('[class="mediumseagreen"]');
